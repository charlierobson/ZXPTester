        ...
        private Boolean isNotificationForTargetDevice(Message m)
            ...
            try
                ...
                if ((devBroadcastHeader.dbch_devicetype == DBT_DEVTYP_DEVICEINTERFACE))
                    ...
                    //Debug.WriteLine(string.Format("expect name {0}, got {1}", deviceNameString, deviceInformation.devicePathName));
                    ...
                    if ((String.Compare(deviceNameString.ToLower(new CultureInfo("en-US")),
                        deviceInformation.devicePathName.ToLower(new CultureInfo("en-US")), true) == 0)) return true;
                        return false;
                    }
                }
            catch (Exception)
