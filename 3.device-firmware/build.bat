...
"%mccpath%mplink.exe" /p18F4550 "rm18f4550 - HID Bootload.lkr" "main.o" "usb_descriptors.o" "usb_device.o" "usb_function_hid.o" "debug.o" "interfacing.o" "business.o" /u_CRUNTIME /z__MPLAB_BUILD=1 /o"device-firmware.cof" /M"device-firmware.map" /W
